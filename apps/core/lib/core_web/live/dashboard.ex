      ...
      <ContentArea>
        ...
        <DynamicGrid>
          <div :for={{ card <- @owned_studies  }} >
            <PrimaryStudy conn={{@socket}} path_provider={{@path_provider}} card={{card}} click_event_data={{%{action: :edit, card_id: card.id } }} />
          </div>
          <div :for={{ card <- @subject_studies  }} >
            <PrimaryStudy conn={{@socket}} path_provider={{@path_provider}} card={{card}} click_event_data={{%{action: :public, card_id: card.id } }} />
          </div>
        ...
        <DynamicGrid>
          <div :for={{ card <- @available_studies  }} class="mb-1" >
            <SecondaryStudy conn={{@socket}} path_provider={{@path_provider}} card={{card}} click_event_data={{%{action: :public, card_id: card.id } }} />
          </div>
        </DynamicGrid>
      </ContentArea>
    """
