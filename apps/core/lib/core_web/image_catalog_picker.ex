    ...
    <div class="bg-white rounded">
      <div class="pl-6 pr-6 pt-6 pb-8 lg:pt-8 lg:pb-10 lg:pr-8 lg:pl-8">
        <div class="flex flex-row">
          ...
          <button type="button" class="w-button-sm h-button-sm flex-wrap cursor-pointer active:opacity-50" x-on:click="open = false, $parent.overlay = false">
            <img src={{ @path_provider.static_path(@conn, "/images/close.svg")}} />
          </button>
        </div>
              ...
              <div :for={{ {image, index} <- Enum.with_index(@search_results) }}>
                ...
                >
                  ...
                  <div
                    ...
                    :class="{ 'visible': selected === {{index}}, 'invisible': selected != {{index}} }"
                  >
                    <img class="w-full h-full object-none" src={{ @path_provider.static_path(@conn, "/images/checkmark.svg")}} />
                  </div>
