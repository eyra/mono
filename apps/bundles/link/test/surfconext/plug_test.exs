defmodule SurfConext.FakeOIDC do
...
defmodule SurfConext.AuthorizePlug.Test do
  use ExUnit.Case, async: true
  use Plug.Test
  alias SurfConext.AuthorizePlug
...
defmodule SurfConext.CallbackPlug.Test do
  use ExUnit.Case, async: true
  use Link.DataCase
  use Plug.Test
  alias SurfConext.CallbackPlug
