defmodule Link.Accounts.User do
  @moduledoc """
  ...
  schema "users" do
    ...
    has_one :profile, Link.Accounts.Profile
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, Link.Repo)
  ...
  """
  def valid_password?(%Link.Accounts.User{hashed_password: hashed_password}, password)
