...
function setUpSpecialNavs() {
  $(".navbar-toggler").click(function (t) {
    var a,
      e,
      o = $(this).closest("nav"),
      i = o.find("ul.site-navigation"),
      l = i.clone();
    i.parent().is(".fullscreen-nav, .sidebar-nav") &&
      (t.stopPropagation(),
      i.parent().addClass("nav-special"),
      $(this).hasClass("selected-nav")
        ...
        : ($(this).addClass("selected-nav"),
          (a = o.attr("class").replace("navbar", "").replace("row", "")),
          (e = i
            .parent()
            .attr("class")
          ...
          (function () {
            ...
            $(".blocsapp-special-menu blocsnav li").each(function () {
              $(this).parent().hasClass("dropdown-menu")
                ...
                : ((a += e),
                  $(this)
                    .attr("style", "animation-delay:" + a + "ms")
                    .addClass("animated " + t));
            });
          })(),
          setTimeout(function () {
...
function extraNavFuncs() {
  function a(t) {
    ...
    return (
      ...
      e.parent().hasClass("navbar-nav") ||
        t.closest(".nav-special").length ||
        a.next().css({ top: a[0].offsetTop, left: e.outerWidth() - 4 }),
      !1
    );
  }
...
function scrollToTarget(t, a) {
  ...
  0 == t
    ...
    $(a).is("[data-scroll-speed]") &&
      ((e = $(a).attr("data-scroll-speed")), parseInt(e) && (e = parseInt(e))),
...
function stickyNavToggle() {
  var t, a, e, o, i;
  $(".sticky-nav").length &&
    ((t = $(".sticky-nav").offset().top),
    (a = "sticky"),
    (e = $(".page-container")),
    (o = $(".sticky-nav").hasClass("fill-bloc-top-edge")) &&
      ((e = $(".fill-bloc-top-edge.sticky-nav").parent()),
      (a = "sticky animated fadeInDown")),
    $(".sticky-nav").hasClass("sticky") &&
      (t = $(".sticky-nav").attr("data-original-offset")),
    $(window).scrollTop() > t
      ? $(".sticky-nav").hasClass("sticky") ||
        ($(".sticky-nav").addClass(a).attr("data-original-offset", t),
        (t = $(".sticky-nav").height()),
        o &&
          ("rgba(0, 0, 0, 0)" == (i = e.css("background-color")) &&
            (i = "#FFFFFF"),
...
function inViewCheck() {
  $($(".hideMe").get().reverse()).each(function (t) {
    ...
    e.height() > $(window).height() && (o = e.offset().top),
      o < i &&
        ((a = e.attr("class").replace("hideMe", "animated")),
...
function setUpVisibilityToggle() {
  $(document).on("click", "[data-toggle-visibility]", function (t) {
    t.preventDefault();
    var a,
      e = $(this).attr("data-toggle-visibility");
    function o(t) {
      t.is("img")
        ? t.toggle()
        : t.is(".row, .bloc-group")
...
function setUpLightBox() {
  window.targetLightbox,
    ...
    $(document).on("click", ".next-lightbox, .prev-lightbox", function (t) {
      ...
      var i,
        l = o.attr("data-lightbox");
      ".mp4" == l.substring(l.length - 4)
        ? ((i = 1 == o.attr("data-autoplay") ? "autoplay" : ""),
        ...
        : ($("#lightbox-image").attr("src", l).addClass("d-block").show(),
          $("#lightbox-video-container").hide(),
          $(".lightbox-caption").removeClass("d-block").hide(),
          o.attr("data-caption") &&
            $(".lightbox-caption").html(o.attr("data-caption")).show()),
        (targetLightbox = o),
        $(".next-lightbox, .prev-lightbox").hide(),
        "no-gallery-set" == a
          ? ($("a[data-lightbox]").index(o) !=
              $("a[data-lightbox]").length - 1 && $(".next-lightbox").show(),
            0 < $("a[data-lightbox]").index(o) && $(".prev-lightbox").show())
          : ($('a[data-gallery-id="' + a + '"]').index(o) !=
              $('a[data-gallery-id="' + a + '"]').length - 1 &&
              $(".next-lightbox").show(),
            0 < $('a[data-gallery-id="' + a + '"]').index(o) &&
              $(".prev-lightbox").show());
    });
}
...
$(function () {
  extraNavFuncs(),
    ...
    $(".nav-item [data-active-page]").addClass(
      $(".nav-item [data-active-page]").attr("data-active-page")
    ),
