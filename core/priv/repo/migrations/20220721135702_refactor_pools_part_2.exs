defmodule Core.Repo.Migrations.RefactorPoolsPart2 do
  ...
  defp add_organisations() do
    ...
    _vu_sbe =
      add_node(:faculty, "vu/sbe", [{:en, "SBE"}], [{:en, "School of Business and Economics"}])

    _vu_bk = add_node(:scholar_program, "vu/sbe/bk", [{:en, "BK"}], [{:nl, "Bedrijfskunde"}])

    _vu_iba =
      add_node(:scholar_program, "vu/sbe/iba", [{:en, "IBA"}], [
    ...
    rpr_1_2021 =
      add_node(
        :scholar_course,
        "vu/sbe/rpr/:year1/:2021",
        [{:en, "RPR 1st year"}, {:nl, "RPR 1e jaar"}],
        [{:en, "RPR 1st year (2021)"}, {:nl, "RPR 1e jaar (2021)"}]
      )

    rpr_2_2021 =
      add_node(
        :scholar_course,
        "vu/sbe/rpr/:year2/:2021",
        [{:en, "RPR 2nd year"}, {:nl, "RPR 2e jaar"}],
        [{:en, "RPR 2nd year (2021)"}, {:nl, "RPR 2e jaar (2021)"}]
      )

    bk_1_2021 =
      add_node(
        :scholar_class,
        "vu/sbe/bk/:year1/:2021",
        [{:en, "BK 1st year"}, {:nl, "BK 1e jaar"}],
        [{:en, "BK 1st year (2021)"}, {:nl, "BK 1e jaar (2021)"}]
      )

    bk_1_h_2021 =
      add_node(
        :scholar_class,
        "vu/sbe/bk/:year1/:resit/:2021",
        [{:en, "BK 1st year (re-sit)"}, {:nl, "BK 1e jaar (herkansing)"}],
        [{:en, "BK 1st year (resit, 2021)"}, {:nl, "BK 1e jaar (herkansing, 2021)"}]
      )

    bk_2_2021 =
      add_node(
        :scholar_class,
        "vu/sbe/bk/:year2/:2021",
        [{:en, "BK 2nd year"}, {:nl, "BK 2e jaar"}],
        [{:en, "BK 2nd year (2021)"}, {:nl, "BK 2e jaar (2021)"}]
      )

    bk_2_h_2021 =
      add_node(
        :scholar_class,
        "vu/sbe/bk/:year2/:resit/:2021",
        [{:en, "BK 2nd year (re-sit)"}, {:nl, "BK 2e jaar (herkansing)"}],
        [{:en, "BK 2nd year (re-sit, 2021)"}, {:nl, "BK 2e jaar (herkansing, 2021)"}]
      )

    iba_1_2021 =
      add_node(
        :scholar_class,
        "vu/sbe/iba/:year1/:2021",
        [{:en, "IBA 1st year"}, {:nl, "IBA 1e jaar"}],
        [{:en, "IBA 1st year (2021)"}, {:nl, "IBA 1e jaar (2021)"}]
      )

    iba_1_h_2021 =
      add_node(
        :scholar_class,
        "vu/sbe/iba/:year1/:resit/:2021",
        [{:en, "IBA 1st year (re-sit)"}, {:nl, "IBA 1e jaar (herkansing)"}],
        [{:en, "IBA 1st year (resit, 2021)"}, {:nl, "BK 1e jaar (herkansing, 2021)"}]
      )

    iba_2_2021 =
      add_node(
        :scholar_class,
        "vu/sbe/iba/:year2/:2021",
        [{:en, "IBA 2nd year"}, {:nl, "IBA 2e jaar"}],
        [{:en, "IBA 2nd year (2021)"}, {:nl, "IBA 2e jaar (2021)"}]
      )

    iba_2_h_2021 =
      add_node(
        :scholar_class,
        "vu/sbe/iba/:year2/:resit/:2021",
        [{:en, "IBA 2nd year (re-sit)"}, {:nl, "BK 2e jaar (herkansing)"}],
        [{:en, "IBA 2nd year (re-sit, 2021)"}, {:nl, "IBA 2e jaar (herkansing, 2021)"}]
      )
  ...
  defp add_node(type, identifier, short_name, full_name)
       when is_list(short_name) and is_list(full_name) do
  ...
  defp add_node(type, identifier, short_name_bundle_id, full_name_bundle_id)
       when is_list(identifier) do
  ...
  defp link_student_class(user_id, "bk_1"),
    do: link_student_org(user_id, "vu/sbe/bk/:year1/:2021")

  defp link_student_class(user_id, "bk_1_h"),
    do: link_student_org(user_id, "vu/sbe/bk/:year1/:resit/:2021")

  defp link_student_class(user_id, "bk_2"),
    do: link_student_org(user_id, "vu/sbe/bk/:year2/:2021")

  defp link_student_class(user_id, "bk_2_h"),
    do: link_student_org(user_id, "vu/sbe/bk/:year2/:resit/:2021")

  defp link_student_class(user_id, "iba_1"),
    do: link_student_org(user_id, "vu/sbe/iba/:year1/:2021")

  defp link_student_class(user_id, "iba_1_h"),
    do: link_student_org(user_id, "vu/sbe/iba/:year1/:resit/:2021")

  defp link_student_class(user_id, "iba_2"),
    do: link_student_org(user_id, "vu/sbe/iba/:year2/:2021")

  defp link_student_class(user_id, "iba_2_h"),
    do: link_student_org(user_id, "vu/sbe/iba/:year2/:resit/:2021")
