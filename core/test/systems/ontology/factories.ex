defmodule Systems.Ontology.Factories do
    ...
    def insert_concept(phrase, %{} = author, opts \\ []) do
        ...
        Factories.insert!(:ontology_concept, %{phrase: phrase, author: author, ai_generated: ai_generated?})
    end

    def insert_predicate(%{} = subject, %{} = predicate, %{} = object, %{} = author, opts \\ []) do
        ai_generated? = Keyword.get(opts, :ai_generated, false)
        Factories.insert!(:ontology_predicate, %{subject: subject, predicate: predicate, object: object, author: author, ai_generated: ai_generated?})
    end
