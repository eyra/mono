defmodule Systems.Test.RoutedLiveViewTest do
  ...
  describe "basic rendering" do
    ...
    test "renders page with single child", %{conn: conn} do
      ...
      assert has_element?(view, "[data-testid='routed-live-view']")
      assert has_element?(view, "[data-testid='embedded-view-child1']")
    end
    ...
    test "renders page with multiple children", %{conn: conn} do
      ...
      assert html =~ "Routed LiveView Test Page"
      assert has_element?(view, "[data-testid='embedded-view-child1']")
      assert has_element?(view, "[data-testid='embedded-view-child2']")
    end
  end
  ...
  describe "embedded view interaction" do
    test "embedded view renders items", %{conn: conn} do
      ...
      assert has_element?(view, "[data-testid='item-10']")
      assert has_element?(view, "[data-testid='item-20']")
      assert has_element?(view, "[data-testid='item-30']")
    end
    ...
    test "multiple children render with their own items", %{conn: conn} do
      ...
      assert has_element?(view, "[data-testid='item-40']")
      assert has_element?(view, "[data-testid='item-50']")
    end
  end
end
