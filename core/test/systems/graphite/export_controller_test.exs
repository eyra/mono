  ...
  test "export/1 valid with pull request commit" do
    ...
    %{id: id} =
      ...
      Factories.insert!(:graphite_submission, %{
        tool: tool,
        description: "description",
        github_commit_url: "https://github.com/eyra/mono/pull/717/commits/119d6db9138837e63d102ba39d157e986066fba3"
      })
  ...
  test "export/1 with invalid submission" do
    ...
    %{id: id} =
      ...
      Factories.insert!(:graphite_submission, %{
        tool: tool,
        description: "description",
        github_commit_url: "https://github.com/eyra/mono/commit/5405deccef0aa1a594cc09da99185860bc3e0cd"
      })
