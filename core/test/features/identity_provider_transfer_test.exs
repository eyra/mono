defmodule CoreWeb.Features.IdentityProviderTransferTest do
  use CoreWeb.FeatureCase

  alias Core.Repo
  alias Systems.Account.Identity.Email.UserModel
  ...
  feature "confirm removes existing authentication satellites", %{session: session} do
    ...
    refute Repo.get_by(Systems.Account.Identity.Google.UserModel, user_id: user.id)
  end
end
