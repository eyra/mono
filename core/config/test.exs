...
config :wallaby,
  ...
  # (TabBar, LiveContent, ...) drown failure messages. Set WALLABY_JS_LOGGER=1
  # to re-enable when debugging a JS-side issue. JS errors (SEVERE) are
  # unaffected and still fail tests via Wallaby.JSError.
