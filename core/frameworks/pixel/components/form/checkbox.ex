    ...
    >
      ...
      >
        <div
          ...
          x-bind:class={"{ '#{active_bg_color(@accent)}': active, '#{inactive_bg_color(@background)} border-2 #{get_border_color({false, field_has_error?(assigns, @form), @background})}': !active }"}
        >
          <img
            x-show="active"
