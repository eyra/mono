defmodule Core.ImageHelpers do
  ...
  def get_photo_url(%{photo_url: nil, gender: :woman}), do: "/images/profile_photo_default_female.svg"
  def get_photo_url(%{photo_url: nil}, _), do: "/images/profile_photo_default.svg"
