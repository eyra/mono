...
defmodule Systems.Lab.DayEntryTimeSlotItem.Example do
  ...
  def render(assigns) do
    ~H"""
    <div class="w-full">
      <DayEntryTimeSlotItem :props={{start_time: -900, enabled?: true, bullet: "1.", number_of_seats: 1, number_of_reservations: 1, target: self() }} />
      <DayEntryTimeSlotItem :props={{start_time: -0, enabled?: true, bullet: "2.", number_of_seats: 2, number_of_reservations: 2, target: self() }} />
      <DayEntryTimeSlotItem :props={{start_time: 900, enabled?: true, bullet: "3.", number_of_seats: 3, number_of_reservations: 3, target: self() }} />
      <DayEntryTimeSlotItem :props={{start_time: 1000, enabled?: true, bullet: "4.", number_of_seats: 4, number_of_reservations: 0, target: self() }} />
      <DayEntryTimeSlotItem :props={{start_time: 2600, enabled?: true, bullet: "5.", number_of_seats: 5, number_of_reservations: 0, target: self() }} />
      <DayEntryTimeSlotItem :props={{start_time: 1100, enabled?: false, bullet: "-", number_of_seats: 6, number_of_reservations: 2, target: self() }} />
      <DayEntryTimeSlotItem :props={{start_time: 1200, enabled?: false, bullet: "-", number_of_seats: 7, number_of_reservations: 0, target: self() }} />
    </div>
    """
  end
end
