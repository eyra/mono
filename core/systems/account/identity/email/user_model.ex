defmodule Systems.Account.Identity.Email.UserModel do
  @moduledoc """
  Satellite identity record for email-first signups.

  Mirrors the pattern of `Systems.Account.Identity.Google.UserModel`, `Systems.Account.Identity.Apple.UserModel`, etc.
