defmodule Systems.Account.Identity.Provider do
  @moduledoc """
  ...
  The orchestrator in `Systems.Account.Identity` is the only caller of these
  callbacks; it relies on each implementation being thin and stateless
  beyond the satellite row.

  See `Systems.Account.Identity.Surfconext` and `Systems.Account.Identity.Google` for the canonical implementations.
  """
