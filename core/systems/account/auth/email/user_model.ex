defmodule Systems.Account.Auth.Email.UserModel do
  @moduledoc """
  Satellite identity record for email-first signups.

  Mirrors the pattern of `Systems.Account.Auth.Google.UserModel`, `Systems.Account.Auth.Apple.UserModel`, etc.
