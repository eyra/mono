defmodule Systems.Fund.CurrencyModel do
  ...
  schema "currencies" do
    field(:name, :string)
    field(:type, Ecto.Enum, values: Fund.CurrencyTypes.schema_values())
    field(:decimal_scale, :integer)
    belongs_to(:label_bundle, Content.TextBundleModel, on_replace: :update)
    has_one(:bank_account, Fund.BankAccountModel, foreign_key: :currency_id)
    has_many(:funds, Fund.Model, foreign_key: :currency_id)
