  ...
  def view_model(
    ...
    earned_label =
      dgettext("eyra-assignment", "earned.label",
        amount: Fund.CurrencyModel.label(currency, locale, earned_amount)
      )

    pending_label =
      dgettext("eyra-assignment", "pending.label",
        amount: Fund.CurrencyModel.label(currency, locale, pending_amount)
      )

    togo_label =
      dgettext("eyra-assignment", "togo.label",
        amount: Fund.CurrencyModel.label(currency, locale, togo_amount)
      )
