defmodule Systems.Zircon.Queries do
  ...
  def screening_tool_query do
    from(t in ToolModel, as: :zircon_screening_tool)
  end
  ...
  def screening_tool_reference_file_query(%ToolModel{id: tool_id}) do
  ...
  def screening_tool_annotation_assoc_query(%ToolModel{id: tool_id}) do
    build(screening_tool_annotation_assoc_query(), :screening_tool_annotation_assoc, tool: [id == ^tool_id])
  end
  ...
  def screening_session_query(%ToolModel{id: tool_id}) do
