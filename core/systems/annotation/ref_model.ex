defmodule Systems.Annotation.RefModel do
  ...
  @fields ~w()a
  @required_fields ~w()a
  @unique_fields ~w(type_id user_id resource_id annotation_id ontology_ref_id)a
  ...
  # down graph
  def preload_graph(:down), do: [:type, :annotation, :ontology_ref, :user, :resource]
  ...
  # up graph
  def preload_graph(:up), do: [:associations]
